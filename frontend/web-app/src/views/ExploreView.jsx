...
export default function ExploreView() {
  ...
  return (
    <div className="flex w-full h-[calc(100vh-90px)] max-h-[calc(100vh-90px)] space-x-6 p-6 bg-[#0A0A0A] text-white font-sans overflow-hidden box-border">
            ...
            <div className="bg-zinc-950 p-5 rounded-2xl border border-zinc-700 space-y-4 shadow-inner">
              ...
              <div className="grid grid-cols-2 gap-2 border-y border-zinc-800 py-3 font-mono text-xs">
                ...
                <div>
                  ...
                  <span className="text-emerald-400 font-extrabold block mt-0.5">Active Walking</span>
                </div>
              </div>
              <button 
                type="button"
