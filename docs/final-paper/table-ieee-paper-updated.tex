...
%
% RESOLVED (2026-08-06): all Section V-A service-performance figures come
% from the two k6 load-test runs executed against staging on 2026-07-22,
% recorded in docs/performance-testing.md (Results Log) before the
% environment was decommissioned:
...
% results log (docs/performance-testing.md). Section V-A reports those
% figures.
%
...
% closing paragraph of Section III-E). What this approach cannot do is
% produce figures that were never measured — hence the placeholders below
% stay red rather than being filled by extrapolation.
%
% STILL OUTSTANDING as of this revision:
%   - Section IV (Visual Insights): Figs. 2-3, regenerate from
%     mode_training_and_evaluation_03.ipynb
%   - Section V-C: SUS score and participant count; formal accessibility
%     audit (keyboard pass rate, contrast result)
% ---------------------------------------------------------------------------
